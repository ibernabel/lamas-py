  ...
  "inline-flex items-center justify-center rounded-full border border-transparent px-2.5 py-0.5 text-xs font-semibold w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-colors overflow-hidden",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-[var(--danger-bg)] text-[var(--danger-fg)] border border-[var(--danger-fg)]/20",
        success:
          "bg-[var(--success-bg)] text-[var(--success-fg)] border border-[var(--success-fg)]/20",
        warning:
          "bg-[var(--warning-bg)] text-[var(--warning-fg)] border border-[var(--warning-fg)]/20",
        outline:
